    ...
    <div class="col">
        <div class="contenedorFormularioLogin">
            ...
            <form id="frm_login" name="frm_login">
                ...
                <div class="contenedorLogin">
                    <input class="login password" type="password" id="txt_password" name="txt_password" placeholder="Contraseña"
                        pattern=".{6,}" required>
                    <span class="simbolo">
                        ...
                        <div class="row frm_crearCuenta">                     
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="cajaTexto" min="0" type="number" name="txt_cedula" id="txt_cedula" placeholder="Cedula">
                                </div>
                            ...
                            <div class="col segundaParte">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="cajaTexto" min="0" type="number" name="txt_telefono" id="txt_telefono" placeholder="Telefono">
                                </div>

                                <div class="form-group">
                                    <label for="txt_correo" class="col-form-label fredoka">Correo</label>
                                    <input class="cajaTexto" type="email" name="txt_correo" id="txt_correo" placeholder="Email">
                                </div>
                        ...
                        <div class="row frm_crearCuentaMascota">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="cajaTexto" type="text" name="txt_nombreMascota" id="txt_nombreMascota" placeholder="Nombre de la mascota" value="">
                                </div>

                                <div class="form-group">
                                    <label for="txt_edadMascota" class="col-form-label fredoka">Edad de la mascota</label>
                                    <input class="cajaTexto" min="0" type="number" name="txt_edadMascota" id="txt_edadMascota" placeholder="Edad de la mascota">
                                </div>
