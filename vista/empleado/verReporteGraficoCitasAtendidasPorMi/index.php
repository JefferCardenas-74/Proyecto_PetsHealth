...
<head>
    ...
    <!-- estilos del  reporte -->
   <link rel="stylesheet" href="../../../componente/css/reporteGraficoCitasAtendidasVeterinario/reporteGraficoCitasAtendidasVeterinario.css">
    <!--api de google para graficas  -->
    <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <!-- script de la vista -->
    <script src="../../../js/reporteGraficoCitasAtendidasVeterinario/reporteGraficoCitasAtendidasVeterinario.js" ></script>
