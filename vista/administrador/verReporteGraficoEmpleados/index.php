...
<head>
    ...
    <!-- estilos del  reporte -->
   <link rel="stylesheet" href="../../../componente/css/reporteGraficoEmpleado/reporteGraficoEmpleado.css">
    <!--api de google para graficas  -->
    <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <!-- script de la vista -->
    <script src="../../../js/reporteGraficoEmpleado/reporteGraficoEmpleado.js" ></script>

<body>


    <header><?php include "../menu.php" ?></header>
    <section><?php include "frm_reporteEmpleado.php" ?> </section>
