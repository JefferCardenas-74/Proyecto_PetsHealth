...
<section class="container-fluid ">
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-4 dosS">

            <div class="cardx">
                <div class="imgBx">
                    <img src="https://i.imgur.com/13UzvP7.jpg" class="img-fluid" alt="imagen revision general">
                </div>
        ...
        <div class="col-12 col-lg-4 tresS">
            ...
            <div class="cardx">
                <div class="imgBx">
                    <img src="https://i.imgur.com/ALxyFmX.jpg" class="img-fluid" alt="imagen masaje">
                </div>
                <!-- <h6 class="cardx-h5 ">Ver mas</h6> -->
                <div class="contenidoServices">
